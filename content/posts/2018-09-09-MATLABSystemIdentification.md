...
{{<tweet user="dango_bot" id="1043442561703002112">}}
...
応答は下の動画のようになりました.
{{<tweet user="dango_bot" id="1037251127668953088">}}
...
{{<tweet user="dango_bot" id="1035434404766597120">}}

### マイクロマウス東日本大会
前日に突っ込んだパラメーターで走りました. ありがとうMATLAB

{{<tweet user="dango_bot" id="1035891915332308992">}}
...
{{<tweet user="dango_bot" id="1037256307525337088">}}


これは+-1.5Vの電圧をかけたときの応答の様子です.

{{<tweet user="dango_bot" id="1042781867143884800">}}
...
{{<tweet user="dango_bot" id="1038418648526860290">}}
